  ...
  return (
    <section className="hero">
      <div
        ...
        style={{
          transform: `translateY(${parallaxOffset}px) translateX(-50%)`,
        }}
      />

      <div
        className={`hero-container reveal ${isVisible ? "active" : ""}`}
        ref={contentRef}
      >
        <h1>
        ...
        <p className="reveal-delay-1">
          Track expenses, set budgets, and achieve your financial goals with the
          most intuitive expense tracker on the market.
        </p>
